                                                    ...
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                          ...
                                                          <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="username">{{ __('admin.Logo') }}</label>
                                                                    ...
                                                                    <button id="output_logo" type="button"
                                                                            ...
                                                                            style="
                                                                                ...
                                                                                background-image: url({{ asset('storage/files_admin/'.($setting->logo ?? 'default.png')) }});
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="username">{{ __('admin.Footer Logo') }}</label>
                                                                    <input type='file' onchange="loadFile_image1(footer_logo)" name="footer_logo" id="footer_logo"
                                                                            class="@error('footer_logo') is-invalid @enderror"
                                                                            style="display:none;"/>
                                                                    <button id="output_footer_logo" type="button"
                                                                            onclick="document.getElementById('footer_logo').click();" value="emad"
                                                                            style="
                                                                                width: 150px;
                                                                                height: 150px;
                                                                                border-radius: 50%;
                                                                                background-color: #cecbcb;
                                                                                background-image: url({{ asset('storage/files_admin/'.($setting->footer_logo ?? 'default.png')) }});
                                                                                background-repeat: no-repeat;
                                                                                background-size: cover;
                                                                                background-position: center;
                                                                                "/>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="username">{{ __('admin.Favicon ') }}</label>
                                                                    <input type='file' onchange="loadFile_image2(favicon)" name="favicon" id="favicon"
                                                                            class="@error('favicon') is-invalid @enderror"
                                                                            style="display:none;"/>
                                                                    <button id="output_favicon" type="button"
                                                                            onclick="document.getElementById('favicon').click();" value="emad"
                                                                            style="
                                                                                width: 90px;
                                                                                height: 90px;
                                                                                border-radius: 50%;
                                                                                background-color: #cecbcb;
                                                                                background-image: url({{ asset('storage/files_admin/'.($setting->favicon ?? 'default.png')) }});
                                                                                background-repeat: no-repeat;
                                                                                background-size: cover;
                                                                                background-position: center;
                                                                                "/>
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <input type="text" name="lg_header" class="form-control" value="{{ old('lg_header',($setting->sidebar_lg_header ?? '')) }} ">
                                                          </div>

                                                          <div class="form-group">
                                                              <label for="">{{__('admin.Sidebar Small Header')}}</label>
                                                              <input type="text" name="sm_header" class="form-control" value="{{ old('sm_header',($setting->sidebar_sm_header ?? '')) }}">
                                                          </div>
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <input type="text" name="currency_icon" class="form-control" value="{{ old('currency_icon',($setting->currency_icon ?? '')) }} ">
                                                          </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action=" " method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Home Tow Footer Logo')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($setting->footer_logo_two) }}" alt="" width="200px">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Howe Two New Logo')}}</label>
